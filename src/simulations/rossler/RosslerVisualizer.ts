...
export class RosslerVisualizer implements SimulationVisualizer {
  ...
  init(container: HTMLElement): void {
    ...
    this.camera.up.set(0, 0, 1); // Z-axis up for Rössler spike visualization
