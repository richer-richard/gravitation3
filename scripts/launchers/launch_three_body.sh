...
# Gravitation³ - Three-Body Simulation Launcher
# Automatically starts AI server and opens simulation

echo "🚀 Launching Three-Body Simulation with AI..."
...
echo "Opening Three-Body Simulation..."
if [[ "$OSTYPE" == "darwin"* ]]; then
    # macOS
    open three-body/sim.html
elif [[ "$OSTYPE" == "linux-gnu"* ]]; then
    # Linux
    xdg-open three-body/sim.html
fi

echo ""
echo "=================================================="
echo "Three-Body Simulation with AI is now running!"
echo "=================================================="
echo ""
